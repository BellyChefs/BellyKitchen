...
mixin _$SettingsDetails {
  ...
  String get notificationsMode => throw _privateConstructorUsedError;
...
abstract class $SettingsDetailsCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String currentLanguage, String notificationsMode, String themeMode});
}
    ...
    return _then(_value.copyWith(
      currentLanguage: null == currentLanguage
          ...
          : currentLanguage // ignore: cast_nullable_to_non_nullable
              as String,
      notificationsMode: null == notificationsMode
          ? _value.notificationsMode
          : notificationsMode // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_SettingsDetails implements _SettingsDetails {
  ...
  @override
  final String notificationsMode;
  @override
  final String themeMode;

  @override
  String toString() {
    return 'SettingsDetails(currentLanguage: $currentLanguage, notificationsMode: $notificationsMode, themeMode: $themeMode)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.notificationsMode, notificationsMode) ||
                other.notificationsMode == notificationsMode) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, currentLanguage, notificationsMode, themeMode);
...
abstract class _SettingsDetails implements SettingsDetails {
  const factory _SettingsDetails(
      ...
      required final String notificationsMode,
      required final String themeMode}) = _$_SettingsDetails;

  @override
  String get currentLanguage;
  @override
  String get notificationsMode;
  @override
